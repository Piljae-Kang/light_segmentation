...
images_path = glob.glob(f"/media/piljae/X31/Dataset/Hubitz/depth_compute/original_images/multi_angles/cs45/*.png")
...
filterings = ["median", "gaussian", "none", "median_gaussian"]
        ...
        for filtering_type in filterings:
            for alpha in alpha_list:
                for beta in beta_list:
                    ...
                    if filtering_type == "median":
                    ...
                    elif filtering_type == "vertical_gaussian":
                        # gaussian filtering
                        ...
                        w_1 = sigmoid(alpha * filtering(filtering(image1 - image3, parameter=kernel_size), parameter=gaussian_parameter, type=1), alpha=beta)
                        w_2 = sigmoid(alpha * filtering(filtering(image2 - image4, parameter=kernel_size), parameter=gaussian_parameter, type=1), alpha=beta)
                        w_3 = sigmoid(alpha * filtering(filtering(image3 - image1, parameter=kernel_size), parameter=gaussian_parameter, type=1), alpha=beta)
                        w_4 = sigmoid(alpha * filtering(filtering(image4 - image2, parameter=kernel_size), parameter=gaussian_parameter, type=1), alpha=beta)
