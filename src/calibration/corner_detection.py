...
def compute_homography(horizontal_images_path, vertical_images_path):
    ...
    for i in range(0, len(horizontal_images_path), 2):
        ...
        # h_blackh = median_filter_4d (h_black[None],kernel_size=3, isnp=True)[0]
        # h_whiteh = max_filter_4d (h_white[None],kernel_size=3, isnp=True)[0]
        # h_blackv = min_filter_4d (h_black[None],kernel_size=5,horizontal=False, isnp=True)[0]
        # h_whitev = max_filter_4d (h_white[None],kernel_size=5,horizontal=False, isnp=True)[0]
        # h_blackv = median_filter_4d (h_blackv[None],kernel_size=3,horizontal=False, isnp=True)[0]
        # h_whitev = median_filter_4d (h_whitev[None],kernel_size=3,horizontal=False, isnp=True)[0]
        # h_blackv = min_filter_4d (h_blackv[None],kernel_size=3,horizontal=False, isnp=True)[0]
        # h_whitev = max_filter_4d (h_whitev[None],kernel_size=3,horizontal=False, isnp=True)[0]

        h_img_white = cv2.imread(horizontal_images_path[-2])
        checkerboard_img = h_img_white
  
        h_img_white = h_img_white.astype(np.float32) / 255.0



        # cv2.imshow("img_white.png", h_img_white)

        h_img_white_r = h_img_white

        h_img_white = median_filter_4d (h_img_white[None],kernel_size=5, isnp=True)[0]
        h_img_white = median_filter_4d (h_img_white[None],horizontal=True,kernel_size=5, isnp=True)[0]
        h_img_white = median_filter_4d (h_img_white[None],kernel_size=5, isnp=True)[0]
        h_img_white = median_filter_4d (h_img_white[None],horizontal=True,kernel_size=5, isnp=True)[0]
        h_img_white = median_filter_4d (h_img_white[None],kernel_size=5, isnp=True)[0]
        h_img_white = median_filter_4d (h_img_white[None],horizontal=True,kernel_size=5, isnp=True)[0]
    ...
    # print(H)
    # print("\nStatus of each point (1: inlier, 0: outlier):")
    # print(status)
    ...
    pattern_img = cv2.imread("/home/piljae/Dropbox/hubitz/pattern/hubitz_projector/my_pattern_images/horizontal/pattern6_0.png")
    ...
    return H, checkerboard_img, pattern_img